...
class Pipe(pygame.sprite.Sprite):
    ...
    def create(screen):
        ...
        spacing_start = np.random.randint(
            delimit, (screen_h - delimit) - Ground.height)

        top = Pipe(screen, screen_w, 0, Pipe.width,
                   spacing_start, pipe_top=True)
        ...
        bottom = Pipe(screen, screen_w, bottom_top, Pipe.width, bottom_bottom)
